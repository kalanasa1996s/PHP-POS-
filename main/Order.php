        ...
        <div id="page-content-wrapper">
                    ...
                    <div class="col-md-2">
                        ...
                        <div id="myModal" class="modal">
                            ...
                            <div class="modal-content" style="width: 1000px;margin-top: 10px">
                                ...
                                <p style="font-family: 'Ramabhadra', sans-serif;"> Order Information</p>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <a href="Order.php">  <button type="button" class="btn btn-primary btn-lg" style="width: 136px"> Save </button></a>
                ...
                <div class="col-md-4">
                    ...
                    <div class="ui right labeled input col-md-4">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" aria-label="Dollar amount (with dot and two decimal places)  " placeholder="Total" style="width: 200px">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <h6>Discount :</h6>
                    <input class="form-control" type="text" placeholder="Default input v">
